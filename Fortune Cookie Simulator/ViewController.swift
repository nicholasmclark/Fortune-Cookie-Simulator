...
//
//  Created by Nicholas Clark on 3/21/18.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        fortuneLabel.text = "Press Cookie To Get Your Fortune"
    }
    ...
    func generateRandomFortune() {
        let randomArrayIndex = Int(arc4random_uniform(54))
        fortuneLabel.text = fortuneArray[randomArrayIndex]
    }
